...
dir_a = '/home/ubuntustudio2/Desktop/#makana#/U_with_21khz/ODVIZZO/'
...
##    output = sound1.overlay(sound2, position=(sound1.duration_seconds - 500))
##    output = sound1.overlay(sound2, position=0300)

    # save the result
    file = file.replace(".mp3", " 21khz")
